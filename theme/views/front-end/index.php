<?php $this->load->view('front-end/shared/header.php'); ?>
	<section id="portfolio">
		...
		<div class="row row-0-gutter">
			...
			<div class="col-md-6 col-0-gutter">
				<div class="ot-portfolio-item">
					<figure class="effect-bubba">
						<img src="<?php echo base_url() ?>theme/front-end-assets/images/demo/portfolio-1.jpg" alt="img02" class="img-responsive" />
						<figcaption>
							<h2>Dean & Letter</h2>
							<p>Branding, Design</p>
			...
			<div class="col-md-6 col-0-gutter">
				<div class="ot-portfolio-item">
					<figure class="effect-bubba">
						<img src="<?php echo base_url() ?>theme/front-end-assets/images/demo/portfolio-2.jpg" alt="img02" class="img-responsive" />
						<figcaption>
		...
		<div class="row row-0-gutter">
			...
			<div class="col-md-6 col-0-gutter">
				<div class="ot-portfolio-item">
					<figure class="effect-bubba">
						<img src="<?php echo base_url() ?>theme/front-end-assets/images/demo/portfolio-3.jpg" alt="img02" class="img-responsive" />
						<figcaption>
							<h2>Lamp & Velvet</h2>
							<p>Branding, Web Design</p>
			...
			<div class="col-md-6 col-0-gutter">
				<div class="ot-portfolio-item">
					<figure class="effect-bubba">
						<img src="<?php echo base_url() ?>theme/front-end-assets/images/demo/portfolio-4.jpg" alt="img02" class="img-responsive" />
						<figcaption>
							<h2>Smart Name</h2>
							<p>Branding, Design</p>
		...
		<div class="row row-0-gutter">
			...
			<div class="col-md-6 col-0-gutter">
				<div class="ot-portfolio-item">
					<figure class="effect-bubba">
						<img src="<?php echo base_url() ?>theme/front-end-assets/images/demo/portfolio-5.jpg" alt="img02" class="img-responsive" />
						<figcaption>
							<h2>Fast People</h2>
							<p>Branding, Web Design</p>
			...
			<div class="col-md-6 col-0-gutter">
				<div class="ot-portfolio-item">
					<figure class="effect-bubba">
						<img src="<?php echo base_url() ?>theme/front-end-assets/images/demo/portfolio-6.jpg" alt="img02" class="img-responsive" />
						<figcaption>
							<h2>Kites & Stars</h2>
							<p>Branding, Web Design</p>
							<a href="#" data-toggle="modal" data-target="#Modal-2">View more</a>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="team-item">
						<div class="team-image">
							<img src="<?php echo base_url() ?>theme/front-end-assets/images/demo/author-2.jpg" class="img-responsive" alt="author">
						</div>
						<div class="team-text">
							<h3>TOM BEKERS</h3>
				...
				<div class="col-md-4">
					<div class="team-item">
						<div class="team-image">
							<img src="<?php echo base_url() ?>theme/front-end-assets/images/demo/author-6.jpg" class="img-responsive" alt="author">
						</div>
						<div class="team-text">
							<h3>LINA GOSATA</h3>
				...
				<div class="col-md-4">
					<div class="team-item">
						<div class="team-image">
							<img src="<?php echo base_url() ?>theme/front-end-assets/images/demo/author-4.jpg" class="img-responsive" alt="author">
						</div>
						<div class="team-text">
							<h3>John BEKERS</h3>
...
<?php $this->load->view('front-end/shared/footer.php'); ?>